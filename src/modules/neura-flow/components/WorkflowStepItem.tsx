...
import { WorkflowStep, getIconBackgroundColor, getIconColor } from '../config/workflowSteps';
...
export function WorkflowStepItem({ step, onStepClick, onDragStart }: WorkflowStepItemProps) {
  ...
  return (
    <button
      ...
      className="w-full cursor-grab active:cursor-grabbing hover:bg-accent/20 p-3 group rounded-lg text-left transition-colors"
